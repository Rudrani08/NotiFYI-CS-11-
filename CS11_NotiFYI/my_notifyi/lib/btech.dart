...
// import 'package:my_notifyi/banasthali.dart';
import 'package:my_notifyi/user_starred.dart'; // Import the PlacementPage

class Btech extends StatefulWidget {
  const Btech({super.key});

  @override
  State<Btech> createState() => BtechState();
}

class BtechState extends State<Btech> {
  ...
  // Sample event dates
  List<String> eventDates = ['28-03-2024', '27-03-2024', '15-03-2024'];

  // Sample category names
  List<String> categoryNames = ['B.Tech', 'B.Tech', 'B.Tech'];
